...
public class DebugLogAspectJ {
    ...
    @Pointcut("within(@com.cyh.saop.annotation.DebugLog *)")
    ...
    @Pointcut("execution(@com.cyh.saop.annotation.DebugLog * *(..)) || methodInsideAnnotatedType()")
    public void method() {
    } //方法切入点

    @Pointcut("execution(@com.cyh.saop.annotation.DebugLog *.new(..)) || constructorInsideAnnotatedType()")

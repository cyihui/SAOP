...
public final class PermissionUtils {
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + SAOP.getContext().getPackageName()));
        SAOP.getContext().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
